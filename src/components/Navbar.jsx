...
function Navbar() {
  return (
    <nav className="shadow-xl bg-gradient-to-r from-blue-400 to-purple-500" >
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center flex-shrink-0 space-x-3">
            ...
            <span className="text-2xl font-bold text-transparent bg-gradient-to-r from-cyan-800 to-blue-600 bg-clip-text">
              ViewSearch
            </span>
          </div>
          {/* Right Section - Icons */}
